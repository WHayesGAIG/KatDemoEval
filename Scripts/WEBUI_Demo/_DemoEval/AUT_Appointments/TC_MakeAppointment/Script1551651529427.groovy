...
WebUI.callTestCase(findTestCase('WEBUI_Demo/_DemoEval/AUT_Appointments/TC_Login'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.selectOptionByValue(findTestObject('Object Repository/otherPage/select_Tokyo CURA Healthcare Center                            Hongkong CURA Healthcare Center                            Seoul CURA Healthcare Center'), 
